...
{
	class AndroidMenuPage : MenuPage
	{
		public AndroidMenuPage(ExtMasterDetailPage master, ExtNavigationPage rootPage) : base(master, rootPage)
		{
            Padding = new Thickness(10, 10, 10, 0);
            StackLayout.Padding = new Thickness(0);

            var logo = this.AddLogo(200);
            logo.Margin = new Thickness(0, 50, 0, 50);
		}
