...
namespace Heleus.Apps.Shared
{
	...
	public class ArgumentsParser
	{
        ...
        public long Long(string name, long def)
        {
            if (!IsSet(name))
                return def;

            if(long.TryParse(this[name], out var result))
                return result;
            return def;
        }
        ...
        public bool String(string name, out string value)
        {
            if(!IsSet(name))
            {
