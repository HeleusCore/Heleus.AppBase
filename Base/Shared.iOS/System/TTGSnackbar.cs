...
namespace TTG
{
	...
	public class TTGSnackbar : UIView
	{
		...
		public nfloat BottomMargin { get; set; } = -22;
		public nfloat Height { get; set; } = 40;
		...
		public TTGSnackbar() : base(CoreGraphics.CGRect.FromLTRB(0, 0, 320, 44))
		{
			...
			this.ActionButton.TitleLabel.Font = UIFont.SystemFontOfSize(16, UIFontWeight.Light);
			...
			this.SecondActionButton.TitleLabel.Font = UIFont.SystemFontOfSize(14, UIFontWeight.Light);
		...
		*/
		public void Show()
		{
			...
			{
				Log.Write("TTGSnackbar needs a keyWindows to display.");
			}
		}
